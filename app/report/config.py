...
# 각 지표별 모델 R² (베이스 모델 학습 결과)
# 이 값은 XGBoost 베이스 모델 학습 후 저장된 결과
MODEL_R2 = {
    'ROA': 0.4034,              # 중간 신뢰도
    'ROE': 0.3365,              # 낮은 신뢰도
    '매출액영업이익률': 0.6626,   # 중간 신뢰도
    '부채비율': 0.8148,          # 높은 신뢰도
    '자기자본비율': 0.9428,       # 높은 신뢰도
    '자본잠식률': 0.9881,         # 높은 신뢰도
    '단기차입금비율': 0.7897,     # 높은 신뢰도
    '유동비율': 0.8687,          # 높은 신뢰도
    '당좌비율': 0.8703,          # 높은 신뢰도
    '유동부채비율': 0.7856,       # 높은 신뢰도
    'CFO_자산비율': 0.2775,      # 낮은 신뢰도
    'CFO_매출액비율': 0.5164,    # 중간 신뢰도
    'CFO증감률': 0.2973,         # 낮은 신뢰도
}
