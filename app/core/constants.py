...
MODEL_R2: Dict[str, float] = {
    'ROA': 0.4187,              # Tuned (+0.0153)
    'ROE': 0.3564,              # Tuned (+0.0199)
    '매출액영업이익률': 0.6664,   # Tuned (+0.0038)
    '부채비율': 0.8197,          # Tuned (+0.0049)
    '자기자본비율': 0.9430,       # Tuned (+0.0002)
    '자본잠식률': 0.9897,         # Tuned (+0.0016)
    '단기차입금비율': 0.7897,     # Base (튜닝 성능 저하)
    '유동비율': 0.8720,          # Tuned (+0.0033)
    '당좌비율': 0.8723,          # Tuned (+0.0020)
    '유동부채비율': 0.8015,       # Tuned (+0.0159)
    'CFO_자산비율': 0.2987,      # Tuned (+0.0212)
    'CFO_매출액비율': 0.5254,    # Tuned (+0.0090)
    'CFO증감률': 0.2973,         # Base (튜닝 성능 저하)
}
